...
class ProductType(models.Model):
    """
    ProductType table will provide a list of the different of product that are for sales
    """
...
class ProductSpecification(models.Model):
    """
    The Product Specification Table contains product specification
...
class ProductImage(models.Model):
    ...
    image = models.ImageField(verbose_name=_("image"), help_text=_("Upload a product image")
                              , upload_to="images/",default="images/1.jpg")
